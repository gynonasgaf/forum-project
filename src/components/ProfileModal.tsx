...
import { X, Camera, Save, Award, TrendingUp, Upload } from 'lucide-react';
...
export default function ProfileModal({ isOpen, onClose, profile, onProfileUpdate }: ProfileModalProps) {
  ...
  useEffect(() => {
    if (isOpen && profile && !profile.is_verified) {
          ...
          <div className="p-6">
            <div className="flex items-center justify-between mb-6">
              ...
              <div className="flex items-center space-x-2">
                {/* Verification Button - Only show for non-verified users */}
                {!profile.is_verified && !hasVerificationRequest && (
                  <button
